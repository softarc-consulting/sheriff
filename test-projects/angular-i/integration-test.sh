...
node  --loader ts-node/esm ../verify-linter.mts ./angular-i/tests/expected-dynamic-import-lint.json ./angular-i/dynamic-import-lint.json
...
node  --loader ts-node/esm ../verify-linter.mts ./angular-i/tests/expected-deep-import-lint.json ./angular-i/deep-import-lint.json
...
node  --loader ts-node/esm ../verify-linter.mts ./angular-i/tests/expected-dependency-rule-lint.json ./angular-i/dependency-rule-lint.json
...
node  --loader ts-node/esm ../verify-linter.mts ./angular-i/tests/expected-internal-error-processing-lint.json ./angular-i/internal-error-processing-lint.json "$(pwd)"
git checkout sheriff.config.ts
