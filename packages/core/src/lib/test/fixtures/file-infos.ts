...
export const angularCliValid = new UnassignedFileInfo('src/app/app.component' as FsPath, [
  new UnassignedFileInfo('src/app/customers/index.ts' as FsPath, [
    new UnassignedFileInfo('src/app/customers/customer.component.ts' as FsPath),
  ]),
